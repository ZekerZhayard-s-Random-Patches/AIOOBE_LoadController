...
import io.github.zekerzhayard.aioobe_loadcontroller.CopyOnWriteArrayListWithMutableIterator;
 ...
 * {@link CopyOnWriteArrayListWithMutableIterator} of values.
 *
...
public final class CopyOnWriteArrayListWithMutableIteratorMultimap<K, V> extends AbstractListMultimap<K, V> {
     ...
     * capacities.
     */
    public static <K, V> CopyOnWriteArrayListWithMutableIteratorMultimap<K, V> create() {
        return new CopyOnWriteArrayListWithMutableIteratorMultimap<K, V>();
    }
    ...
    public static <K, V> CopyOnWriteArrayListWithMutableIteratorMultimap<K, V> create(
        ...
        return new CopyOnWriteArrayListWithMutableIteratorMultimap<K, V>(expectedKeys, expectedValuesPerKey);
    }
    ...
    public static <K, V> CopyOnWriteArrayListWithMutableIteratorMultimap<K, V> create(
        ...
        return new CopyOnWriteArrayListWithMutableIteratorMultimap<K, V>(multimap);
    }

    private CopyOnWriteArrayListWithMutableIteratorMultimap() {
        super(new HashMap<K, Collection<V>>());
        expectedValuesPerKey = DEFAULT_VALUES_PER_KEY;
    }

    private CopyOnWriteArrayListWithMutableIteratorMultimap(int expectedKeys, int expectedValuesPerKey) {
        super(Maps.<K, Collection<V>>newHashMapWithExpectedSize(expectedKeys));
        checkNonnegative(expectedValuesPerKey, "expectedValuesPerKey");
        this.expectedValuesPerKey = expectedValuesPerKey;
    }

    private CopyOnWriteArrayListWithMutableIteratorMultimap(Multimap<? extends K, ? extends V> multimap) {
    ...
    /**
     * Creates a new, empty {@code CopyOnWriteArrayListWithMutableIterator} to hold the collection of values for
     * an arbitrary key.
     */
    @Override List<V> createCollection() {
        return new CopyOnWriteArrayListWithMutableIterator<V>();
    }
